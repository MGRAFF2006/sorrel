...
//! and no cross-repo path, only the two vendored files. It complements
//! `tests/policy_conformance.rs`, which proves the runner permission gate agrees
//! with the manifest decisions and that forged bundles cannot bypass it.
