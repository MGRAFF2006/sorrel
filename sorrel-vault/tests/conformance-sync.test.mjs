...
//
// tests/conformance/policy-conformance.json is a vendored copy of the canonical
...
// policy-conformance.test.mjs, which proves Vault only releases secrets when the
// injected corePolicy.evaluate() returns allow.
//
